 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) {
                document.addEventListener("click", (function(e) {
                    ...
                    } else if (!e.target.closest(".menu__link")) menuClose();
                }));
                document.addEventListener("keydown", (function(e) {
                    e.code === "Escape" ? menuClose() : null;
                    console.log(e.code);
                }));
            }
        }
        ...
        function initSliders() {
            ...
            if (document.querySelector(".order__slider")) new swiper_core_Swiper(".order__slider", {
                modules: [ Autoplay, Thumb, Pagination, Navigation, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
